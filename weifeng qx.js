 ...
 * 适用：QuantumultX（圈X）
 *
 * 安装：将本文件 raw URL 填入圈X → 重写 → 引用 一键导入
 *
 * #!name=威锋签到
 * #!desc=自动获取Cookie并每日签到
 * #!openUrl=https://www.feng.com
 * #!author=自用
 *
 * [rewrite_local]
 * # 拦截威锋App请求，自动提取保存Cookie
 * ^https?://api\.feng\.com/ url script-request-header weifeng_qx.js
 * ^https?://www\.feng\.com/ url script-request-header weifeng_qx.js
 *
 * [task_local]
 * # 每天早上8点自动签到
 * 0 8 * * * weifeng_qx.js, tag=威锋签到, img-url=https://www.feng.com/favicon.ico, enabled=true
 */
